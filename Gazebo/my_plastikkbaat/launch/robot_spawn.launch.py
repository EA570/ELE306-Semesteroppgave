...
def generate_launch_description():
    ...
    package_name = 'my_plastikkbaat'
    
    # Define location of the xacro file that describes the robot model
    #xacro_file_path = os.path.join(get_package_share_directory(package_name), 'urdf', 'mobile_manipulator.xacro')
    xacro_file_path = "/home/rocotics/ros2_ws/src/my_plastikkbaat/urdf/robot_description.urdf.xacro"
    

    #Robot starting position and orientation
    robot_pos = ['0.0', '0.0', '0.1']
    robot_yaw = '0.0'
    ...
    cmd=['ros2', 'control', 'load_controller', '--set-state', 'start','boat_arm_controller'],
    output='screen'
)
